...
static uint8_t colstart = ST7735_COLSTART;
static uint8_t rowstart = ST7735_ROWSTART;
...
esp_err_t st7735_init(const st7735_config_t *cfg) {
    ...
    colstart = ST7735_COLSTART; rowstart = ST7735_ROWSTART; display_width = ST7735_WIDTH; display_height = ST7735_HEIGHT;
...
void st7735_set_rotation(uint8_t rotation) {
    uint8_t madctl;
    switch (rotation % 4) {
        case 0: madctl=0x08; colstart=ST7735_ROWSTART; rowstart=ST7735_COLSTART; display_width=ST7735_WIDTH; display_height=ST7735_HEIGHT; break;
        case 1: madctl=0x78; colstart=ST7735_COLSTART; rowstart=ST7735_ROWSTART; display_width=ST7735_HEIGHT; display_height=ST7735_WIDTH; break;
        case 2: madctl=0xC8; colstart=ST7735_ROWSTART; rowstart=ST7735_COLSTART; display_width=ST7735_HEIGHT; display_height=ST7735_WIDTH; break;
        case 3: madctl=0xB8; colstart=ST7735_COLSTART; rowstart=ST7735_ROWSTART; display_width=ST7735_WIDTH; display_height=ST7735_HEIGHT; break;
        default: return;
    }
